...
@Component({
  ...
  template: `
    <div class="relative w-full overflow-hidden bg-slate-50/50 min-h-screen">
      <!-- HERO SECTION -->
      <section class="relative min-h-[85vh] flex flex-col justify-center items-center px-4 sm:px-6 text-center pt-12 sm:pt-16 pb-16 sm:pb-20 max-w-7xl mx-auto">
        ...
        <div class="max-w-4xl space-y-6 z-10 animate-fade-in">
          ...
          <h1 class="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tight text-[#111827] leading-[1.1] font-sans break-words">
          ...
          <p class="text-sm sm:text-base md:text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed font-normal">
            AI-powered Resume Analysis and Mock Interviews to help you land your dream job.
          </p>
        </div>

        <!-- HERO CARDS (EXACTLY TWO CARDS AS REQUESTED) -->
        <div class="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mt-10 sm:mt-14 z-10">
          
          <!-- Card 1: AI Resume Analyzer -->
          <div class="group relative bg-white border border-slate-200/80 rounded-2xl sm:rounded-3xl p-6 sm:p-10 shadow-xl shadow-slate-200/50 hover:shadow-2xl hover:shadow-[#0145F2]/10 hover:border-[#0145F2]/40 transition-all duration-300 flex flex-col justify-between text-left transform hover:-translate-y-1">
            <div class="space-y-5">
              <div class="w-12 sm:w-14 h-12 sm:h-14 rounded-2xl bg-blue-50 border border-blue-100 flex items-center justify-center text-[#0145F2] shadow-sm group-hover:scale-110 transition-transform">
              ...
              <div class="space-y-2">
                ...
                <h3 class="text-xl sm:text-2xl font-bold text-slate-900 group-hover:text-[#0145F2] transition-colors">
                  AI Resume Analyzer
                </h3>
            ...
            <div class="pt-6 sm:pt-8">
              <a 
                ...
                class="inline-flex items-center justify-center w-full py-3.5 sm:py-4 px-6 rounded-2xl bg-gradient-to-r from-[#0145F2] to-[#1E5BFA] text-sm font-bold text-white shadow-lg shadow-blue-500/25 hover:opacity-95 active:scale-[0.99] transition-all group-hover:shadow-blue-500/40"
              >
          ...
          <div class="group relative bg-white border border-slate-200/80 rounded-2xl sm:rounded-3xl p-6 sm:p-10 shadow-xl shadow-slate-200/50 hover:shadow-2xl hover:shadow-[#0145F2]/10 hover:border-[#0145F2]/40 transition-all duration-300 flex flex-col justify-between text-left transform hover:-translate-y-1">
            <div class="space-y-5">
              ...
              <div class="space-y-2">
                ...
                <h3 class="text-xl sm:text-2xl font-bold text-slate-900 group-hover:text-purple-600 transition-colors">
                  AI Mock Interview
                </h3>
                <p class="text-xs sm:text-sm text-slate-600 leading-relaxed">
            ...
            <div class="pt-6 sm:pt-8">
              <a 
                ...
                class="inline-flex items-center justify-center w-full py-3.5 sm:py-4 px-6 rounded-2xl bg-gradient-to-r from-slate-900 to-slate-800 hover:from-[#0145F2] hover:to-[#1E5BFA] text-sm font-bold text-white shadow-lg shadow-slate-900/20 hover:shadow-blue-500/30 active:scale-[0.99] transition-all"
              >
      ...
      <section class="py-12 sm:py-20 px-4 sm:px-6 max-w-7xl mx-auto border-t border-slate-200/80">
        <div class="text-center max-w-3xl mx-auto space-y-4 mb-10 sm:mb-16">
          <h2 class="text-2xl sm:text-3xl font-extrabold text-slate-900 break-words">Why Candidates Choose Intervexa AI</h2>
          <p class="text-xs sm:text-sm text-slate-600">Built to simulate real hiring manager evaluations and job ATS algorithms.</p>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 text-left">
          <div class="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/80 shadow-sm space-y-3">
