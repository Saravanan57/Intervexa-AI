...
@Component({
  ...
  template: `
    <div class="min-h-[90vh] flex items-center justify-center py-8 sm:py-12 px-3.5 sm:px-6">
      <div class="max-w-xl w-full bg-white border border-[#D9E2F1] rounded-2xl sm:rounded-3xl shadow-xl p-5 sm:p-8 relative animate-fade-in text-left">
        ...
        <div class="space-y-1.5 mb-6 text-center">
          ...
          <h2 class="text-2xl sm:text-3xl font-extrabold text-[#111827] font-sans break-words">Create Account</h2>
